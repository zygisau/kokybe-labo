...
public abstract class AbstractMarshallerImpl implements Marshaller
{
     ...
     * been set
     */
    protected String getNoNamespaceSchemaLocation() {
     ...
     */
    protected void setNoNamespaceSchemaLocation( String location ) {
     ...
     * @return Java encoding name corresponding to the provided IANA name
     */
     ...
     * @param name of a property that needs to be set
     * @param value that will be set to the provided name
     */
